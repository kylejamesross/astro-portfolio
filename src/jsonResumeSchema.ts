        ...
        z
          .object({
            ...
            type: z
              ...
              .optional(),
            languages: z
              .array(z.string().describe("e.g. C#, JavaScript, Rust"))
              .describe("Specify the lanugages used on this project")
              .optional(),
            libraries: z
              .array(z.string().describe("e.g. React#, Dotnet Core"))
              .describe("Specify the libraries used on this project")
              .optional(),
          })
          .catchall(z.any())
      )
